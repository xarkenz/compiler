...
.block.6:
	...
	store %"type.::AVLTreeNode"* %38, %"type.::AVLTreeNode"** %self
	br label %.block.7
.block.4:
...
.block.11:
	...
	store %"type.::AVLTreeNode"* %64, %"type.::AVLTreeNode"** %self
	br label %.block.12
.block.9:
...
.block.5:
	...
	br i1 %19, label %.block.6, label %.block.7
.block.6:
	%20 = load i64, i64* %left
	store i64 %20, i64* %max
	br label %.block.8
.block.7:
	%21 = load i32({}*, {}*)*, i32({}*, {}*)** %comparator
	%22 = load i64, i64* %left
	%23 = load {}**, {}*** %array
	%24 = getelementptr inbounds {}*, {}** %23, i64 %22
	%25 = load {}*, {}** %24
	%26 = load i64, i64* %right
	%27 = load {}**, {}*** %array
	%28 = getelementptr inbounds {}*, {}** %27, i64 %26
	%29 = load {}*, {}** %28
	%30 = call i32({}*, {}*) %21({}* %25, {}* %29)
	%31 = icmp sgt i32 %30, 0
	br i1 %31, label %.block.9, label %.block.10
.block.9:
	%32 = load i64, i64* %left
	store i64 %32, i64* %max
	br label %.block.11
.block.10:
	%33 = load i64, i64* %right
	store i64 %33, i64* %max
	br label %.block.11
.block.11:
	br label %.block.8
.block.8:
	%34 = load i32({}*, {}*)*, i32({}*, {}*)** %comparator
	%35 = load i64, i64* %max
	%36 = load {}**, {}*** %array
	%37 = getelementptr inbounds {}*, {}** %36, i64 %35
	%38 = load {}*, {}** %37
	%39 = load {}*, {}** %target
	%40 = call i32({}*, {}*) %34({}* %38, {}* %39)
	%41 = icmp sgt i32 %40, 0
	br i1 %41, label %.block.12, label %.block.13
.block.12:
	%42 = load i64, i64* %index
	%43 = load {}**, {}*** %array
	%44 = getelementptr inbounds {}*, {}** %43, i64 %42
	%45 = load i64, i64* %max
	%46 = load {}**, {}*** %array
	%47 = getelementptr inbounds {}*, {}** %46, i64 %45
	%48 = load {}*, {}** %47
	store {}* %48, {}** %44
	%49 = load i64, i64* %max
	store i64 %49, i64* %index
	br label %.block.14
.block.13:
	br label %.block.3
.block.14:
	br label %.block.1
.block.3:
	%50 = load i64, i64* %index
	%51 = load {}**, {}*** %array
	%52 = getelementptr inbounds {}*, {}** %51, i64 %50
	%53 = load {}*, {}** %target
	store {}* %53, {}** %52
	ret void
}
